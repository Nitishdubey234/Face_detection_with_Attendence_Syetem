...
class Train:
    def __init__(self,root):
        ...
        title_lbl=Label(self.root,text="TRAIN DATA SET",font=("ttimes new roman",35,"bold"),bg="white",fg="red")
...
# === Button=========
        ...
        img_bottom=Image.open("College_images/peoples.jpg")
...
# ======= Import the Classifier And Save ==========
